            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl">
                <div className="flex items-center justify-center">
                  <div
                    className="loading-color inline-flex items-center px-4 py-2 font-semibold leading-6 text-xl transition ease-in-out duration-150"
                  >
                    <svg className="animate-spin ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-10 w-10 loading-color"
